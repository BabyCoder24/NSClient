...
const UserResetDialog: React.FC<UserResetDialogProps> = ({
  open,
  user,
  onClose,
  onConfirm,
  ...
  return (
      ...
      slotProps={{
        paper: {
          sx: {
            ...
            boxShadow: "0px 32px 60px rgba(33, 150, 243, 0.35)",
    ...
    >
      ...
      >
        ...
        >
          Send the user a secure password reset link via email.
        </Typography>
        <IconButton
          aria-label="close"
          onClick={onClose}
      ...
      >
        <Box sx={{ textAlign: "center" }}>
          <LockReset sx={{ fontSize: 64, color: "info.main", mb: 2 }} />
          ...
          <Typography variant="body2" sx={{ mt: 2 }}>
            A secure reset link will be sent to their email address.
          </Typography>
        </Box>
      </DialogContent>
      <DialogActions
